...
@implementation CloudFormationStackResourceSummaryUnmarshaller
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([elementName isEqualToString:@"StackResourceSummary"]) {
        if (caller != nil) {
...
-(CloudFormationStackResourceSummary *)response
{
    if (nil == response) {
        response = [[CloudFormationStackResourceSummary alloc] init];
    }
    return response;
}
