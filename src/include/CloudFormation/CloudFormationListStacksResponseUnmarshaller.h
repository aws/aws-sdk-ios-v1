...
/**
 * List Stacks Result Unmarshaller
 */
@interface CloudFormationListStacksResponseUnmarshaller:CloudFormationResponseUnmarshaller {
    CloudFormationListStacksResponse *response;
}

@property (nonatomic, readonly) CloudFormationListStacksResponse *response;
