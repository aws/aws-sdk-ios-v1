...
/**
 * Describe Stacks Result Unmarshaller
 */
@interface CloudFormationDescribeStacksResponseUnmarshaller:CloudFormationResponseUnmarshaller {
    CloudFormationDescribeStacksResponse *response;
}

@property (nonatomic, readonly) CloudFormationDescribeStacksResponse *response;
