...
/**
 * Stack Summary Unmarshaller
 */
@interface CloudFormationStackSummaryUnmarshaller:CloudFormationResponseUnmarshaller {
    CloudFormationStackSummary *response;
}


@property (nonatomic, readonly) CloudFormationStackSummary *response;
