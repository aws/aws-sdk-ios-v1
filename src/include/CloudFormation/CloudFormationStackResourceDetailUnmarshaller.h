...
/**
 * Stack Resource Detail Unmarshaller
 */
@interface CloudFormationStackResourceDetailUnmarshaller:CloudFormationResponseUnmarshaller {
    CloudFormationStackResourceDetail *response;
}

@property (nonatomic, readonly) CloudFormationStackResourceDetail *response;
